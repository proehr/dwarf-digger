    ...
    public class InventoryManager : MonoBehaviour {
        ...
        private Collider GetClosestItem() {
            ...
            foreach (Collider currentItem in itemsInRange) {
                float currentDistance = Vector3.Distance(this.player.transform.position, currentItem.transform.position);
                Debug.Log("Current Item: " + currentItem.name + " Distance: " + currentDistance);
